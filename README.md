...
```shell
pip install aa-permission-management==1.2.0
```
...
```
aa-permission-management==1.2.0
```
...
[![Translation status](https://weblate.ppfeufer.de/widget/alliance-auth-apps/aa-permission-management/matrix-auto.svg)](https://weblate.ppfeufer.de/engage/alliance-auth-apps/)
