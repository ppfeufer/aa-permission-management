(function ($, global, undefined) { // eslint-disable-line no-unused-vars, no-shadow-restricted-names
    'use strict';
    ...
    $.quicksearch = {
        defaults: {
            ...
            testQuery: function (query, txt, _row) { // eslint-disable-line no-unused-vars
    ...
    $.fn.quicksearch = function (target, opt) {
        ...
        this.removeDiacritics = function (str) {
            const changes = $.quicksearch.diacriticsRemovalMap;
        ...
        let timeout, cache, rowcache, jq_results, val = '', last_val = '', self = this,
        ...
        this.stripe = function () {
            ...
            if (typeof options.stripeRows === 'object' && options.stripeRows !== null) {
                const joined = options.stripeRows.join(' ');
                const stripeRows_length = options.stripeRows.length;
        ...
        this.strip_html = function (input) {
            let output = input.replace(new RegExp('<[^<]+\\>', 'g'), ' ');
            ...
            if (typeof options.selector === 'string') {
                cache = jq_results.map(function () {
                    return $(this).find(options.selector).map(function () {
                        const temp = self.strip_html(this.innerHTML);
